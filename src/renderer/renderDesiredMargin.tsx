...
const DesiredMargin = React.memo(function ProgressBar(props: ProgressBarProps) {
    const { value } = props;
...
const renderDesiredMargin = (
    ...
    return <DesiredMargin value={params.value} />;
};

export default renderDesiredMargin;
